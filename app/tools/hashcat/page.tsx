  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <p>
          Hashcat is a fast and powerful password recovery tool that supports 
          multiple hash types, including MD5, SHA1, bcrypt, and more. 
          It’s widely used for password cracking during penetration testing 
        ...
        <img 
          src="https://example.com/hashcat_overview.png" 
